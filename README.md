...
void runVppTestsWithDocker() {
    var config = Map.of(
            ...
            "dataspacetck.did.verifier", "did:web:host.docker.internal%3A9876:verifier",
            "dataspacetck.did.holder", "did:web:0.0.0.0%3A8080:holder",
            "dataspacetck.did.thirdparty", "did:web:0.0.0.0%3A8080:thirdparty",
            "dataspacetck.test.package", "org.eclipse.dataspacetck.dcp.verification.presentation.verifier",
            "dataspacetck.vpp.trigger.endpoint", "http://host.docker.internal:3571/api/your/trigger/endpoint"
    );
